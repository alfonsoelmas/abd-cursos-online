...
<html lang="en">
	...
	<body>
		<?php
		$pagina_actual = "Crear asignatura";
		...
		<main class="main-content">
			<div class="fullwidth-block">
				<div class="container">
					<div class="row">
						<div class="col-md-6">
							<h2 class="section-title"><i class="icon-user"></i>Crear asignatura</h2>


							<form id="crear_asignatura" enctype="multipart/form-data" method="post" action="/abd/back/funciones/add_asignatura.php" class="contact-form">
								<p>
						...
						echo "<div class='col-md-4'>";
							echo "<h2 class='section-title'><i class='icon-user'></i>Volver a listado de asignaturas</h2>";
							echo "<p class='text-center'>";
								echo "<a href='listado_asignaturas.php' class='more button secondary'>Volver</a>";
							echo "</p>";
						echo "</div>";
						?>
					</div> <!-- .row -->
