...
/*
Añade usuarios a cursos
Primero debes buscarlos, luego seleccionarlos.
*/
?>
...
<html lang="en">
	...
	<body>
		...
		$pagina_actual = "Asignar usuarios";
		...
		echo "</main>";
			...
			echo "<h1 class='text-center'>Añadir usuarios a curso</h1>";
				...
				echo "<div class='row'>";
					...
					<div class='col-md-3'>
						<div class="widget">
							...
							<form action="add_usuario_curso.php" type="get" class="subscribe">
			...
			if(isset($_GET['busqueda'])){
					...
					//TODO CAMBIAR POR USUARIOS PERO HACER COMO ASIGNATURAS
					...
					echo "<div class='col-md-5'>";
						echo "<aside class='sidebar'>";
							echo "<h2 class='section-title'><i class='icon-book'></i>Selecciona usuario</h2>";
							echo "<p>(Ctrl + click) Para seleccionar varios.</p>";
							echo "<form  class='subscribe' type='get' action='/abd/back/funciones/add_usuarios_to_curso.php'>";

								echo "<select name='usuarios[]' multiple>";
								...
								if($numeroCursos != 0) 	echo "<input type='submit' class='light' value='Añadir usuarios seleccionados'>";
